...
class M2SNet_evaluator():
    def __init__(self, args):
        ...
        self.mode = args.mode
        self.save_path = '/Users/jinbin/5340Proj/alice_stage_1_checkpoints/M2SNet/'+self.mode
        if not os.path.isdir('/Users/jinbin/5340Proj/alice_stage_1_checkpoints/M2SNet/'+self.mode):
    ...
    def evaluate(self, M2SNet, writer, epoch, total_step):
        ...
        for repet in range(1):
            ...
            for step, (music, motion) in pbar:
                ...
                motion = motion.type(torch.FloatTensor).to(device)
        ...
        music_features, motion_features = M2SNet.module.features(mel_1.to(device), motion_1.to(device))#.module for DP
