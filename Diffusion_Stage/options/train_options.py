...
class TrainCompOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--latent_dim', type=int, default=128, help='latent_dim of transformer')
        # self.parser.add_argument('--latent_dim', type=int, default=256, help='latent_dim of transformer')
        ...
        self.parser.add_argument('--eval_every_e', type=int, default=1, help='Frequency of animation results (by epoch)')
